...
namespace Application.Tests
{
    ...
    public class CustomerRepositoryTest
    {
        ...
        {
            //Arrange
            CustomerRepository target = new CustomerRepository(); // Inicializar de manera apropiada
            List<Customer> expected = new List<Customer>(); // Inicializar de manera apropiada
        ...
        public void RemoveTest()
        {
            //Arrange
            CustomerRepository target = new CustomerRepository(); // Inicializar de manera apropiada 
            Customer entity = new Customer();// Inicializar de manera apropiada
            entity.Id = 1;
